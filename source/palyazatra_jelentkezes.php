...
//$palyazatNev = "";
//$pID = $_GET['id'];
//$sql = "SELECT palyazatNev FROM Palyazat WHERE pID = :pID";
...
//        $stmt = oci_parse($conn, "INSERT INTO Kep (kepID, kepNev, fID) VALUES (kep_seq.NEXTVAL, :kepNev, :fID)");
...
//            if (!$check) {
//                die("A feltöltött fájl nem kép.");
//            }
//            if (!move_uploaded_file($_FILES["uploadedFile"]["tmp_name"], $uploadFile)) {
//                echo "A(z) " . htmlspecialchars(basename($_FILES["uploadedFile"]["name"]), ENT_QUOTES, 'UTF-8') . " fájl feltöltése sikertelen.";
//            }
//        }
//
//        // Kép beszúrása + pályázathoz való jelentkezés + kategóriák kezelése
//        if (oci_execute($stmt)) {
//            oci_free_statement($stmt);
//
...
//                exit();
//            } else {
//                $_SESSION['success_message'] = "Kép sikeresen feltöltve pályázat nélkül.";
//            }
//        } else {
//            $e = oci_error($stmt);
