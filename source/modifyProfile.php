        ...
        <form method="POST">
            ...
            <div class="uploadForm">
                <div class="formElement">
                    ...
                    <input id="name" name="name" value="<?php echo $row["FNEV"]?>" placeholder="Felhasználónév" required>
                    <label for="email">Email cím:</label>
                    <input id="email" name="email" type="email" value="<?php echo $row["EMAIL"]?>" placeholder="Email cím" required>
